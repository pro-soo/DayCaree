						...
						<table class="table table-hover" style="width: 100%">
							<tr>
								...
								<td colspan="2"><input type="text"
									class="form-control input-sm" id="w_type" value=" "></td>
							</tr>
							<tr>
								<th>어린이집 이름</th>
								<td><input type="text" class="form-control input-sm"
									id="w_name" value="${vo.w_name}"></td>
								<th>대표자</th>
								<td><input type="text" class="form-control input-sm"
									id="w_leader" value=" "></td>
								<th>원장</th>
								<td><input type="text" class="form-control input-sm"
									id="w_boss" value="${vo.w_boss}"></td>
							</tr>

							<tr>
								<th>어린이집 주소</th>
								<td colspan="8"><input type="text"
									class="form-control input-sm" id="w_address" value=" "></td>
							</tr>
							<tr>
								<th>위반 행위</th>
								<td colspan="8"><input type="text"
									class="form-control input-sm" id="w_act" value=" "></td>
							</tr>
							<tr>
								<th>처분 내용</th>
								<td colspan="8"><input type="text"
									class="form-control input-sm" id="w_content" value=" "></td>
							</tr>
							<tr>
								<td colspan="8">
